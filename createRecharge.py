...
def main():
    ...
    parser.add_argument('-r', action='store_true', help='Overwrite existing recharge folder with new recharge folder')
    ...
    if args.r:
        directory = 'monthlyRechargesTemp/' + str(dates[0])[0:10] + '_TO_' + str(dates[1])[0:10] + '/'
